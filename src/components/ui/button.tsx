  ...
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-lg text-sm font-medium ring-offset-background transition-all duration-300 ease-out focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0 active:scale-[0.97]",
  {
    variants: {
      variant: {
        ...
        gold: "bg-gradient-to-r from-primary to-amber-600 text-primary-foreground font-semibold shadow-gold hover:shadow-gold-lg hover:-translate-y-0.5 active:translate-y-0",
        "gold-outline": "border-2 border-primary text-primary hover:bg-primary hover:text-primary-foreground",
        hero: "bg-gradient-to-r from-primary to-amber-600 text-primary-foreground font-semibold text-base px-8 py-6 shadow-gold hover:shadow-gold-lg hover:-translate-y-1 active:translate-y-0",
        "hero-secondary": "border-2 border-foreground/20 text-foreground hover:bg-foreground/5 hover:border-foreground/30 font-medium text-base px-8 py-6",
