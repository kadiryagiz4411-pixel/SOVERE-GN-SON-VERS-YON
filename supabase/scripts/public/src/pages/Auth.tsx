    ...
    try {
      if (mode === 'forgot-password') {
        ...
        if (refCode && data?.user) {
          localStorage.setItem('sovereign_pending_ref', refCode);
        }
        ...
        if (data?.session) {
          ...
          // Pass ref code via URL to dashboard for processing
          const pendingRef = localStorage.getItem('sovereign_pending_ref');
          if (pendingRef) {
            localStorage.removeItem('sovereign_pending_ref');
            navigate(`/onboarding?ref=${pendingRef}`);
          } else {
            navigate('/onboarding');
          }
        } else {
